...
public class MissileLauncher : WeaponPlayer
{
    ...
    public override void Shoot()
    {
        ...
        if (shootInput == 1f && Time.time > shotTimer)
        {
            ...
            {
                GameObject currentBullet = Instantiate(bullet, new Vector3(playerPos.x, weaponPos.y + weaponLength, playerPos.z), Quaternion.Euler(0f, 0f, 90f));
            ...
            {
                GameObject currentBullet = Instantiate(bullet, new Vector3(weaponPos.x + weaponLength, weaponPos.y, playerPos.z), Quaternion.Euler(0f, playerRot, 0f));
